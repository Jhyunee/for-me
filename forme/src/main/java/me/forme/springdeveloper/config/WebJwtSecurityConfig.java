    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/login", "/user", "/api/statics/checklist", "/community", "/mypage", "/api/mypage/money", "/api/mypage/password", "/api/mypage/auth").permitAll()  // 로그인 엔드포인트는 누구나 접근 가능하도록 설정
